...
- Model template at `<your-claude-dir>/skills/WorldThreatModel/ModelTemplate.md`
...
Save to: `<your-claude-dir>/skills/WorldThreatModel/Models/{horizon}.md`

### Step 5: Update INDEX

Write/update `<your-claude-dir>/skills/WorldThreatModel/Models/INDEX.md`:
...
- Step 1 reads existing state to determine what needs updating
